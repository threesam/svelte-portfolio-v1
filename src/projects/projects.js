...
const projects = [
    {
        ...
        challenge: "At the time, I only had framework experience with React but heard some cool things about Svelte and decided to take the plunge. I cannot overstate how lovely the developer experience is, although when compared to the sheer vastness of the React community, I knew that not every problem had already documented solution.",
        how: "I had implemented a custom p5js particle system, that worked well in vanilla JS, but required a rewire to get it playing nice with Svelte. Ultimately, the code turned out cleaner and I gained a deeper understanding of Javascript in the process."
        // color: 'rgb(51, 85, 37)'
    },
    {
        id: 1,
        ...
        what: "I wanted to try out Sapper and pair it with a headless CMS. Sanity provided a very nice starter template. I was blown away at how beautifully abstracted the whole process was.",
        challenge: "I quickly realized that abstraction, without experience, can make changing functionality and adding features very frustrating very quickly.",
        how: "In order to fully leverage the power of Sapper, I had return to the fundamentals of Svelte, and Javascript, to fully understand the flow of data."
        // color: 'yellow'
    },
    {
        id: 2,
